...
public class RecordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Map<String, ?>  totalRec = new HashMap<>();
    ...
    protected void initRecordPlanData() {
        context= this;
        System.out.println("################initRecordPlanData##############");
        Map<String, ?> totalRec;
    ...
    private void initRecordFileData() {
        Map<String, ?> totalRec;
    ...
    protected void initRecordLogData() {
        context= this;
        System.out.println("################initRecordLogData##############");

        Map<String, ?> totalRec;
        log_list = new ArrayList<>();
        log_sp = getSharedPreferences("RecLog", MODE_PRIVATE);

        if (log_sp == null) { return;}

        totalRec = log_sp.getAll();

        if (totalRec == null) { return;}
